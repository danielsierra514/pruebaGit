...
<div class="col-md-10 col-centered noPadding fullHeight">
  <div id="carruselEstado" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
      <li data-target="#carruselEstado" data-slide-to="0" class="active"></li>
      <li data-target="#carruselEstado" data-slide-to="1" class=""></li>
      <li data-target="#carruselEstado" data-slide-to="2" class=""></li>
    </ol>
    <a class="left carousel-control" href="#carruselEstado" role="button" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="#carruselEstado" role="button" data-slide="next">
