...
$(document).ready(function(){
  ...
  $("#aceptarSeleccionColor").click(function(){
    ...
    if( zonaActual == "#headerPrincipal"){
      colorHeader=$("#colorUnico").val();;
    }
    if( zonaActual == "#footerPrincipal"){
      colorFooter=$("#colorUnico").val();;
    }
...
<div class="modal fade" id="modalSelectorColor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="example">
          <div class="example-title">Color</div>
          <div class="example-content well">
            <div class="example-content-widget">
              <div id="cp2" class="input-group colorpicker-component selectorColor">                
                ...
                <input type="text" value="#DC005A" class="form-control" id="colorUnico" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="aceptarSeleccionColor">Continuar</button>
      </div>
    </div>
  </div>
</div>