                      ...
                      <tbody>
                        <tr>
                          <th class="small-6 large-6 columns first">
                            <table>
                              <tr>
                                <th><a href='http://www.sobreplanos.co'><img src="http://sobreplanos.co/archivos/images/sobrePlanos.png"></a> </th>
                              </tr>
                            </table>
                          </th>
                        ...
                        <th class="small-12 large-12 columns first last">
                          <table>
                            <tr>
                              <th>
                                <br>                                                                
                                <center data-parsed=""> <img class="logoCliente" src="http://www.sobreplanos.co/archivos/logos/%logo%.png" align="right" class="text-right"> </center>
                                <h1>Bienvenido</h1>
                                <p class="text-left">Es un placer darle la bienvenida a tu Empresa a <a href="http://www.sobreplanos.co"><b>sobrePlanos.co</b></a>, la plataforma en línea más innovadora para la publicación de Proyectos Inmobiliarios. Hemos creado una cuenta para tu empresa. Ingresa ahora y empieza a disfrutar de las grandes ventajas de publicar con nosotros.
                                </p>
                                <ul>
                                  ...
                                  <tr>
                                    <td>
                                      <table>
                                        <tr>
                                          <td>
                                            <center data-parsed=""><a href="http://www.sobreplanos.co/activarCuenta.php?idEmpresa=%idEmpresa%" align="center" class="text-center">Ingresar a mi Cuenta</a></center>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
                                ...
                                <h5>Búsqueda por Geolocalizacion</h5>
                                <p>Gracias a GoogleMaps, brindamos  a nuestros clientes una plataforma innovadora que permite la publicación y visualización ágil de Proyectos Inmobiliarios en línea.</p>
                                <img src="http://www.sobreplanos.co/archivos/images/mapaImagen2.png" alt="">
                                <hr>
                                 <img src="http://www.sobreplanos.co/archivos/images/detalleProyectoImagen.png" alt="">
                                <hr>
                                <h4>Rápida Publicación</h4>
                                <p>Publica tus Proyectos Inmobiliarios en Tiempo Record. </p>
                                <img src="http://www.sobreplanos.co/archivos/images/crearProyectoImagen.png" alt="">
                                <hr>
                                <p>Ya hemos creado una cuenta para tu Empresa.</p>
                              </th>
                            </tr>
                          </table>
                        </th>
                      ...
                      <tr>
                        <th class="small-12 large-12 columns first last">
                          <table>
                            <tr>
                              <th>
                                <h3 class="text-center">Que esperas?</h3>
                                <table class="button large expand">
                                  <tr>
                                    <td>
                                      <table>
