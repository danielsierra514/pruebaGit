                      ...
                      <tbody>
                        <tr>
                          <th class="small-6 large-6 columns first">
                            <table>
                              <tr>
                                <th> <img src="http://sobreplanos.co/archivos/images/sobrePlanos.png"> </th>
                              </tr>
                            </table>
                          </th>
                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <h4>Hola %nombrePersona%</h4>
                                <p class="text-left">Próximamente un Agente de la empresa se contactará contigo.</p>
                                
                                 <p class="text-left">A continuación verás toda la información del proyecto de tu interés.</p>
                                <b>Nombre:</b>
                                <p>%nombre%</p>
                                <b>Descripción:</b>
                                <p>%descripcion%</p>
                                <b>Ubicación:</b>
                                <img src="http://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=600x300&maptype=roadmap&format=png&visual_refresh=true&markers=icon:http://www.sobreplanos.co/archivos/icons/marker.png%7Cshadow:true%7C%latitud%,%longitud%">
                                <b>Pais:</b>
                                <p>%pais%</p>
                                <b>Departamento:</b>
                                <p>%departamento%</p>
                                  ...
                                  <tr>
                                    <td>
                                      <table>
                                        <tr>
                                          <td>
                                            <center data-parsed=""><a href="http://www.sobreplanos.co?idProyecto=%idProyecto%" align="center" class="text-center">Ver Publicación</a></center>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
