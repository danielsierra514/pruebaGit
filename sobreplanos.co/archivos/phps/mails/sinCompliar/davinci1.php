...
<head>
  ...
  <style>
    ...
    hr {
      border-bottom: 1px solid #2B3F88;
    }
                        ...
                        <tr>
                          <th class="small-12 large-12 columns first">
                            <table>
                              <tr>
                                <th>
                                  <a href='http://www.sobreplanos.co'><img src="http://sobreplanos.co/archivos/logos/dav.png"></a>
                                </th>
                              </tr>
                            </table>
                          </th>
                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <h5><?= nombreRepresentante ?></h5>
                                <p>
                                  Con la presente estamos informando su estado de cuenta a el día de hoy:
                                </p>
                                <hr>

                                <table>
                                  <tr>
                                    <th class="small-1 large-1 columns"></th>
                                    <th class="small-10 large-10 columns">
                                      Factura # <b><?= numeroFactura ?></b>
                                    ...
                                    <th class="small-1 large-2 columns"></th>
                                  </tr>
                                </table>
                                <hr>
                                <p>
                                  Estamos al pendiente del pago de la factura para reportarlo a Google y evitar posible inconvenientes.
                                </p>
                                <p>
                                  Si ya se realizó el respectivo pago por favor hacer caso omiso a este mensaje y adjuntar el soporte de pago y enviarlo al siguiente correo:
                                </p>
                                <p><a><?= correoUsuario ?></a></p>
                              </th>
                            </tr>
                          </table>
                        </th>
                        ...
                        <tr>
                              ...
                              <tr>
                                <th>
                                  <ul class="no-bullet">
                                    <li><?= nombreUsuario ?></li>
                                    <li><?= cargoUsuario ?> </li>
                                    <li><?= telefonoUsuario ?></li>
                                  </ul>
                                  <hr>
                                  <ul class="no-bullet">
                                    <li>Davinci Technologies SAS</li>
                                    <li>Partner Google Colombia</li>
                                    <li><a href="http://www.davincitech.co" target="_blank">www.davincitech.co</a></li>
                                  </ul>
                                </th>
                              </tr>
                            </table>
                          ...
                          <th class="small-12 large-6 columns first">
                            <table>
                              <tr>
                                <th>
                                  <a href='http://www.sobreplanos.co'><img src="http://sobreplanos.co/archivos/logos/part.png"></a>
                                </th>
                              </tr>
                            </table>
                          </th>
