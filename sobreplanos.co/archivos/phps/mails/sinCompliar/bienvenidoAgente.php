                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <h4>Bienvenido %nombreCompleto%</h4>
                                <p class="text-left">Es un placer darte la bienvenida a <a href="http://www.sobreplanos.co"><b>sobrePlanos.co</b></a><br>%nombreEmpresa% te ha invitado a formar parte de su grupo de trabajo.<br> Desde hora podrás:
                                </p>
                                <ul>
                                  <li>Administrar Proyectos</li>
                                  <li>Contactar Clientes Interesados</li>
                                  <!--<li>Agendar Visitas</li>-->
                                  <li>Compartir Proyectos en Redes Sociales</li>
                                </ul>
                              </th>
                            </tr>
                          </table>
                                  ...
                                  <tr>
                                    <td>
                                      <table>
                                        <tr>
                                          <td>
                                            <center data-parsed=""><a href="http://www.sobreplanos.co/activarAgente.php?idAgente=%idAgente%" align="center" class="text-center">Ingresar a mi Cuenta</a></center>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
