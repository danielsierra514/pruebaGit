<script>
  $(document).ready(function() {
    ...
    $("#completarRegistro").click(function(){
      $("#modalBienvenidaAgente").modal("hide");
...
<div class="modal fade toppest" data-keyboard="false" data-backdrop="static" id="modalBienvenidaAgente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
